...
args.concat_tokens=int(widget_with_default('concat_tokens')[:-1]) # dabs cannot handle number param
...
args.processes=int(widget_with_default('processes', str(min(max(psutil.cpu_count() - 2, 1), 32))+'F')[:-1]) # dabs cannot handle number param
